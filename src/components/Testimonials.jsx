...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      image: Reena2Img, 
      rating: 5,
      text: "മുട്ടുവേദന ആയിരുന്നു എന്റെ പ്രശ്നം. വർഷങ്ങൾ ആയിട്ടുള്ള വേദന സഹിച് മടുത്തു പല ഹോസ്പിറ്റലിലും ചികിൽസിച്ചു, അവസാനം സർജറി അല്ലാതെ വേറെ നിവൃത്തി ഇല്ല എന്ന സാഹചര്യത്തിൽ ആണ് യൂട്യൂബിൽ Sunny സർ ടെ വീഡിയോകൾ വഴി Sci - Vedic product നെപ്പറ്റി അറിയുന്നത്. Product കഴിച്ചു തുടങ്ങി 5 മാസം ആയപോഴേക്കും കാലിന്റെ നീരൊക്കെ മാറിതുടങ്ങിരുന്നു. ഞാൻ over Weight കുറച്ചു. മുൻപ് എനിക്ക് പള്ളിയിൽ പോകാനോ ജോലിക് പോകാനോ ഒന്നും കഴിയില്ലാരുന്നു ഇപ്പോൾ എല്ലാം ചെയ്യാൻ എന്നെകൊണ്ട് പറ്റുന്നുണ്ട്. ഈ product എനിക്ക് വളരെ ആശ്വാസവും സൗഖ്യവും നൽകുന്നുണ്ട്.  സാറിനോടും sci - Vedic നോടും നന്ദിയുണ്ട്"
    },
    {
    ...
    },
    {
      ...
      image: Saneeesh1Img, 
      rating: 5,
      text: "എന്റെ ശരീരത്തിൽ 5 വര്ഷങ്ങളായി ഉണ്ടായിരുന്ന സോറിയാസിസിൽ നിന്ന് മോചനം ലഭിച്ചു. കൈ ചുരുട്ടി സ്വയം ഭക്ഷണം കഴിക്കാൻ പോലും കഴിയില്ലാരുന്നു. എന്നാൽ Sci -Vedic Product എടുത്ത് തുടങ്ങി 11 മത്തെ മാസം മുതൽ മാറ്റം കണ്ടു തുടങ്ങി, 20 ദിവസം ആയപോഴേക്കും ഭൂരിഭാഗവും സൗഖ്യമായി. Sci - vedic Team നോട്‌ ഒരുപാട് നന്ദിയുണ്ട്."
    },
