...
import pankajakshanImg from "../assets/testimonial_pics/pankajakshan.jpeg";
import sisterImg from "../assets/testimonial_pics/sister.jpeg";
// import pankajakshanImg from "../assets/testimonial_pics/pankajakshan.jpeg";
// import pankajakshanImg from "../assets/testimonial_pics/pankajakshan.jpeg";
...
const Testimonials = () => {
  const testimonials = [
    ...
    {
      name: "Pankajakshan",
      place: "Aduvassery, Ernakulam",
      image: pankajakshanImg,
      rating: 5,
      text: "ഞാൻ പങ്കജാക്ഷൻ എറണാകുളം ജില്ലയിൽ അടുവശ്ശേരി സ്ഥലവാസിയാണ് ,ഇപ്പോൾ 79 വയസ്സ് പൂർത്തിയായി . കഴിഞ്ഞ 30 വർഷമായി മാക്കുലർ ഡി ജനറേഷൻ എന്ന നേത്ര രോഗത്താൽ വല്ലാതെ കഷ്ടപ്പെട്ടു നിരവധി ആശുപത്രികളിൽ ചികിത്സ ചെയ്തു. പണവും സമയവും പാഴായി. അങ്ങനെ ഒരു ദിവസം ഫേസ്ബുക് നോക്കിയ എന്റെ ഭാര്യ പറഞ്ഞു എറണാകുളത്തു phoenix ആയുർവേദ ആൻഡ് വെൽനെസ്സ് ക്ലിനിക്കിൽ ഓപ്പറേഷൻ ഇല്ലാതെ, ഇൻജെക്ഷൻ ഇല്ലാതെ ഏതു നേത്ര രോഗവും മാറ്റുന്നു എന്ന വീഡിയോ കണ്ടു എന്ന്. അങ്ങനെ വിളിച്ചുപറഞ്ഞു ട്രീറ്റ്മെന്റിന്നായി എത്തി 21 ദിവസത്തെക്ക്‌ അഡ്മിറ്റ്‌ ആയി ട്രീറ്റ്മെന്റ് സ്റ്റാർട്ട്‌ ചെയ്തു. ഇന്ന് ഒത്തിരി സന്തോഷത്തോടെ മടങ്ങിപ്പോവുകയാണ്. ഇപ്പോൾ വലിയ മാറ്റം കണ്ണിനു സംഭവിച്ചിരിക്കുകയാണ്. ആറു മാസം തുടർച്ചയായി sci-vedic പ്രോഡക്ടസ് കഴിക്കുമ്പോൾ മറ്റുള്ളവർക്ക് കിട്ടിയതുപോലെ പൂർണ കഴ്ച്ച എനിക്കും ലഭിക്കുമെന്ന് പൂർണമായും വിശ്വസിക്കുന്നു. കാരണം മറ്റുള്ളടത്തെ ട്രീറ്റ്മെന്റ് പോലെയല്ല ഇവിടുത്തെ ട്രീറ്റ്മെന്റ്. ഒത്തിരി സന്തോഷം തോന്നുന്നു. 😊"
    },
    {
      name: "Sister",
      place: "Andhra",
      image: sisterImg,
      rating: 5,
      text: "ആന്ധ്രാപ്രാദേശിൽ വിശാഖപട്ടണം കൺവെൻടിലുള്ള സിസ്റ്റർ 81 ആം വയസ്സിൽ ഫിനിക്സ് ആശുപത്രിയിൽ കടന്നുവരുമ്പോൾ നേരിയ കാഴ്ച്ച മാത്രമായിരുന്നു ഉണ്ടായിരുന്നത്. എന്നാൽ മടങ്ങിപ്പോകുന്നത് ഒത്തിരി സൗഖ്യത്തോടെ!!!. സിസ്റ്ററിന്റെ ആഹ്ലാദം കണ്ട മറ്റു മുറികളിൽ താമസിച്ചിരുന്ന രോഗികൾ എല്ലാവരും കൂടി ഒരു ഗംഭീര യാത്ര അയപ്പു കൊടുത്താണ് വിട്ടത് അവരുടെ സന്തോഷത്തിൽ ഞങ്ങളും പങ്കുകൊള്ളുന്നു"
    },
    // {
    //   name: "Lakshmi",
    //   place: "Perumbavoor",
